...
--      ,c045_varchar           VARCHAR                         --  
        ,c046_varchar_s         VARCHAR(16381)                  --  SQL Error [1118] [42000]: Row size too large. The maximum row size for the used table type, not counting BLOBs, is 65535. This includes storage overhead, check the manual. You have to change some columns to TEXT or BLOBs
--      ,c047_varchar_max       VARCHAR(MAX)                    --  
--      ,c048_varchar2          VARCHAR2                        --  
--      ,c049_varchar2_s        VARCHAR2(2)                     --  
        ,c050_nchar             NCHAR                           --  NATIONAL/NCHAR/NVARCHAR implies the character set UTF8MB3, which will be replaced by UTF8MB4 in a future release. Please consider using CHAR(x) CHARACTER SET UTF8MB4 in order to be unambiguous.
        ,c051_nchar_s           NCHAR(255)                      --  NATIONAL/NCHAR/NVARCHAR implies the character set UTF8MB3, which will be replaced by UTF8MB4 in a future release. Please consider using CHAR(x) CHARACTER SET UTF8MB4 in order to be unambiguous.
...
CREATE  TABLE   IF  NOT EXISTS  Test_String_Size(
        ...
        ,Char_n     CHAR(   255  )
        ,VChr_0     VARCHAR
        ,VChr_n     VARCHAR(65535)
        ,Clob_0     LONGTEXT
--      ,Clob_n     LONGTEXT(1063256064)
);
