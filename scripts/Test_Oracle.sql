...
--$ mkdir  C:\Tmp\Gist\oracle
--$ podman run --name oracle -dit -p 1521:1521 -e ORACLE_PWD=Secret -v C:\Tmp\Gist\oracle:/opt/oracle/oradata container-registry.oracle.com/database/free:latest
--
...
--  Test Oracle data types.
--  SEE: https://youtu.be/OTglm9fVCL4?t=173
--  podman run 
--
...
--      ,c082_raw               RAW                             --  
        ,c083_raw_s             RAW(1)                          --  
        ,c084_longraw           LONGRAW                         --  
--      ,c085_long_raw          LONG RAW                        --  ORA-01754: a table may contain only one column of type LONG
--      ,c086_image             IMAGE                           --  
        ,c087_date              DATE                            --  
--      ,c088_time              TIME                            --  
        ,c089_time_p            TIME(1)                         --  
...
--      ,c108_uuid              UUID                            --  
--      ,c109_uniqueidentifier  UNIQUEIDENTIFIER                --  
        ,c110_json              VARCHAR2(4000)  CHECK (c094_json IS JSON)   --  <  21c
--      ,c110_json              JSON                                        --  >= 21c
--      ,c111_xml               XML                             --  
--      ,c112_cidr              CIDR                            --  
--      ,c113_inet              INET                            --  
